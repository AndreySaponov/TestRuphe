...
class TestWin(QWidget):
    ...
    def initUI(self):
        ...
        self.loc = QLocale(QLocale.English, QLocale.UnitedStates) # мова, країна
        ...
        self.line_age.setValidator(self.validator) #вік повинен бути числом!
